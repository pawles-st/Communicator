...
class Logger():
    def __init__(self):
        ...
        self.state = 0 # 0 - nic sie nie dzieje specjalnego, 1 - dostalem check_avalaialabelity i jest wolny email wiec czekam na reszte credentials, 2 - dostalem get_salt i czekam na login_data
